...
-- [[file:README.org::*GridSelect Configuration][GridSelect Configuration:1]]
...
runSelectedAction' conf actions = do
    ...
    case selectedActionM of
        ...
        Nothing -> return ()
-- GridSelect Configuration:1 ends here

-- [[file:README.org::*Gridselect Menus][Gridselect Menus:1]]
-- gsCategories =
...
-- [[file:README.org::*System Sounds][System Sounds:1]]
...
-- System Sounds:1 ends here

-- [[file:README.org::*NamedActions][NamedActions:1]]
...
myKeys c =
  ...
  , ("M-b c",addName " allows access to all dmscripts"         $ spawn "bluetoothconnect")           -- allows access to all dmscripts
  ...
  , ("M-d b",addName " allows access to all dmscripts"         $ spawn "dmenu-bluetooth")           -- allows access to all dmscripts
  ...
  , ("M-p c",addName " choose a colorscheme"                   $ spawn "dtos-colorscheme") -- choose a colorscheme
