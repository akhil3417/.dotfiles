...
-- customization.default.compmgr_args = '--experimental-backends -b --unredir-if-possible --no-fading-openclose'
customization.default.compmgr_args = '--experimental-backends'
customization.default.wallpaper_change_interval = 500
...
uniarg:key_repeat({modkey,"Shift"}, "n", customization.func.tag_view_prev),
