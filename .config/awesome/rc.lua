...
-- customization.default.compmgr_args = '--experimental-backends'
...
tools.system.filemanager.secondary = "nemo"
...
tools.browser.secondary_private = tools.browser.secondary .. " --incognito--private"
...
tools.editor.primary = "emacsclient -c -a 'emacs'"
tools.editor.secondary = "nvim"
...
uniarg:key_numarg({ modkey, "Mod1", "Shift" }, "h",
...
uniarg:key_numarg({ modkey, "Mod1", "Shift" }, "l",
...
uniarg:key_numarg({ modkey, "Mod1", "Shift" }, "k",
...
uniarg:key_numarg({ modkey, "Mod1", "Shift" }, "j",
